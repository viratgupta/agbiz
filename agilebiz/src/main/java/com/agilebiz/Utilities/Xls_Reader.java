...
public class Xls_Reader {
	...
	public String getCellData(String sheetName, int colNum, int rowNum) {
		try {
			...
			if (cell.getCellType() == CellType.STRING)
				...
				// String decimalval= new
				// BigDecimal(cell.getNumericCellValue()).toString();
				// String cellText=
				// decimalval.substring(0,decimalval.indexOf(".")+3);

				// String cellText = new
				// BigDecimal(cell.getNumericCellValue()).toString();
				// String cellText= cellT.replace(".0", "");
				String cellText = String.valueOf(cell.getNumericCellValue()).replace(".0", "");

				if (cellText.contains("E")) {
					cellText = new BigDecimal(cell.getNumericCellValue()).toString().replace(".0", "");
				}
			...
			public boolean setCellData(String sheetName, String colName, int rowNum, String data) {
				try {
					...
					for (int i = 0; i < row.getLastCellNum(); i++) {
						// System.out.println(row.getCell(i).gehtStringCellValue().trim());
	...
	public String getCellData(String sheetName, String colName, int rowNum) {
		try {
			...
			if (cell.getCellType() == CellType.STRING)
				return cell.getStringCellValue();
			else if (cell.getCellType() == CellType.NUMERIC || cell.getCellType() == CellType.FORMULA) { // DecimalFormat
																											// df=new
				DecimalFormat("0.00");
				cell.setCellType(CellType.STRING);
				String cellText = cell.getStringCellValue(); // String cellText
																// =
				String.valueOf(cell.getNumericCellValue());
				if (HSSFDateUtil.isCellDateFormatted(cell)) { // format in form
																// of M/D/YY
					double d = cell.getNumericCellValue();
	...
	public boolean setCellData(String sheetName, String colName, int rowNum, String data, String url) {
		...
		try {
			 ...
			 * cell.setHyperlink(link); cell.setCellStyle(hlink_style);
